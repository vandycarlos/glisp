...
var ErrWrongNargs error = errors.New("wrong number of arguments")
...
func ArrayAccessFunction(env *Glisp, name string, args []Sexp) (Sexp, error) {
	...
	case SexpChar:
		i = int(t)
	default:
		return SexpNull, errors.New("fecond argument of aget must be integer")
	}
